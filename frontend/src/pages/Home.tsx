      ...
      <div className="mx-auto flex min-h-svh max-w-[1600px]">
        ...
        <main className="min-w-0 flex-1 pb-24 lg:pb-8">
          ...
          <div className="px-4 py-6 sm:px-6 sm:py-8 lg:px-10">
            ...
            {tab === "settings" && <SettingsPanel state={state} profileDraft={profileDraft || state.profileName} setProfileDraft={setProfileDraft} updateState={updateState} onSaveProfile={() => { updateState({ profileName: profileDraft || state.profileName }); toast.success("Profil lokal tersimpan."); }} onCsv={exportCsv} onJson={exportJson} onPrint={() => window.print()} onReminder={requestReminder} />}
          </div>
